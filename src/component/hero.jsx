    ...
    >
      <header className="text-center space-y-6 mb-12">
        ...
        >
          ...
          <span className="text-yellow-500 font-bold">adventure</span> and{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full max-w-6xl">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold bg-yellow-300 text-purple-900 px-4 py-2 rounded-lg inline-block">
            Why PIP School?
          </h2>
          <ul className="text-2xl space-y-3">
            <li className="bg-red-400 px-4 py-2 rounded-lg text-white">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-6">
            <Link to="/about">
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="bg-yellow-400 text-purple-900 px-8 py-4 rounded-full font-bold hover:bg-yellow-500 transition duration-300 text-2xl shadow-lg"
              >
                Learn More
              </motion.button>
            </Link>
