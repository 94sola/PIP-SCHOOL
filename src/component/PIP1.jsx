...
const Pip = () => {
  ...
  return (
    <div className="min-h-screen py-16 px-4 flex flex-col items-center" style={{ backgroundColor: pipColors.background }}>
      {/* Header Section */}
      <motion.div
        className="w-full bg-yellow-300 max-w-5xl text-center rounded-3xl py-8 shadow-2xl flex items-center justify-center"
